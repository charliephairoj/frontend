  ...
  function (CameraService) {
    return {
      ...
      link: function postLink(scope, element, attrs) {
        ...
        var userMedia = CameraService.getUserMedia, btn = element.find('.snapshot-btn'), retakeBtn = element.find('.retake-btn'), canvas = element.find('canvas')[0], ctx = canvas.getContext('2d'), video = element.find('video')[0], width = attrs.width || 1280, height = attrs.height || 720;
