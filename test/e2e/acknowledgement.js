xdescribe('Acknowledgements', function () {
	...
	describe('Acknowledgement View Page', function () {
		...
		it('should filter results', function () {
			...
			browser.driver.findElement(by.id('search-bar-input')).sendKeys('charliephairoj');
	...
	ddescribe('Create an new acknowledgement', function () {
		...
		describe('The Setup', function () {
			...
			it('should have a list of projects', function () {
				expect(element.all(by.css('.project-select option')).count()).toBeGreaterThan(0);
			});
		...
		describe("Filling out the form", function () {
			...
			describe('Setting the Purchase Order Number', function () {
				it('should set the purchase order number of the acknowledgement', function () {
					element(by.cssContainingText('.sidebar div.po', 'Set Purchase Order')).click();
			...
			describe('Setting the Delivery Date', function () {
				it('should set the vat of the acknowledgement', function () {
					...
					dateElement.findElement(by.css('a')).getText().then(function (dateVar) {
						day = dateVar;
					});
					...
					promise.then(function () {
						...
						dateElement.click();
						var dateOptions = {year:"numeric", month:'long', day:'numeric', formatMatcher:'basic', weekday:undefined};
						console.log(d.toLocaleDateString('en-US', dateOptions));
